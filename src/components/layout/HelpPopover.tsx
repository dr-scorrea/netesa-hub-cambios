import { HelpCircle, BookOpen, MessageCircle, Keyboard, LifeBuoy, Sparkles, ExternalLink } from "lucide-react";
...
const LINKS = [
  ...
  },
  {
    ...
    href: "mailto:soporte@netesa.com",
  },
];
          ...
          {LINKS.map(({ icon: Icon, title, description, href }) => (
            <li key={title}>
              <a
                ...
                rel="noreferrer"
                className="group flex items-start gap-3 rounded-md px-3 py-2.5 transition-base hover:bg-accent/50"
              >
